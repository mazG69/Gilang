...
#cl.login(qr=True)
cl.login(token="ErQn8mAilEZq64NH5Gsa.l6Ha5iuE5BX8ACSSNwEkQG./zbNDHIAz6z1NakiFJDhZtnHYt9d3mtvo2SF5f4cppo=")
cl.loginResult()

ki = LINETCR.LINE() #bot1
#ki.login(qr=True)
ki.login(token="Er01kUIzhk1qMRTvo5Q7.axnH2Yguj04Psd3egDpc1W.9jRbqmchiGfezrgzS5OFEPLt0aR83T/AtmNhRcWxtsQ=")
ki.loginResult()

ki2 = LINETCR.LINE() #bot2
#ki2.login(qr=True)
ki2.login(token="ErQEdEML6RuGqViZTp91.gjZE6oYT3tri2ONNY1cxiq.v1/Ay8X4at7zEebtN1rGvNaGWHeiyRerlcSqCRdudYQ=")
ki2.loginResult()

ki3 = LINETCR.LINE() #bot3
#ki3.login(qr=True)
ki3.login(token="ErSLIpEcJMyP4bltEwd1.hVdo5LhdcW/YEqHGrrP6aq.jfGvNn2GCB3rbmDGNdmB2R05Di1k2pdZ3b/9gSTIlYE=")
ki3.loginResult()

ki4 = LINETCR.LINE() #bot4
#ki4.login(qr=True)
ki4.login(token="Er8FsqQGKzp4Ah0RJpW1.enK59DQRqwm1E4Jyxbr9mq.RldKDY8RkEJz4AhjSXAfvvY22PpPp6ynsrMBPQmQs/g=")
ki4.loginResult()

ki5 = LINETCR.LINE() #bot5
#ki5.login(qr=True)
ki5.login(token="Erclyi98aROTdknc2ed2.uyKr/g/CsJwFxTiyF9EiqG.Br0RWi0GCzydxkA56H2qylkVbXRBPul7hhsOXkU9bpU=")
ki5.loginResult()


print "=====[MazG Succes Login]====="
reload(sys)
...
admsa = "u2fa840e4851ee5bc7c69cb2c9d678aaa"
...
wait = {
    ...
    'point':False,
    'sidermem':False,
    'message':"Thanks For add me \n🔰[•]READY[•]🔰\n🔰   •>BOT PROTECT \n🔰   •>SELFBOT \n🔰   •>SIRI \nhttp://line.me/ti/p/~kmgutheng69",
    "lang":"JP",
    "comment":"🍌 🍌 Auto Like by MazG™ 🍌 🍌 \n🔰[•]READY[•]🔰\n🔰   •>BOT PROTECT \n🔰   •>SELFBOT \n🔰   •>SIRI \nhttp://line.me/ti/p/~kmgutheng69",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#                            Name = summon(op.param2)
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        cl.sendText(op.param1, "Nah Loh " + "☞ " + Name + " ☜" + "\nCie cie yang jones ngintip aja cie . . .\nSini napa nes  (-__-)   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                    else:
                                        cl.sendText(op.param1, "Ciat Ciat " + "☞ " + Name + " ☜" + "\nBisulan tujuh turunan cctv Mulu . . .\nGabung Sini (-__-)   ")
                                        time.sleep(0.2)
                                        summon(op.param1,[op.param2])
                                else:
                                    cl.sendText(op.param1, "Hayooo " + "☞ " + Name + " ☜" + "\nKak ngapain ngintip ? \nSini Dong ih..   ")
                                    time.sleep(0.2)
                                    summon(op.param1,[op.param2])
                        else:
                            pass
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["",cName + " ᴺᵍᵉᵗᵃᵍ ᴹᵘˡᵘ ᴹᶤᶰᵗᵃ ᴰᶤᵈᵉᶳᵃʰᶤᶰ ᴬᵖᵃ ᴾᵉᶰᵍᵉᶰ ᴰᵉᶳᵃʰᶤᶰ ?, ", cName + " Ƙαηgєη кαк ? ƤM Aנα Ɠαк Uѕαн MαƖυ - MαƖυ",  cName + " ᴷᵉᶳᵉᵖᶤᵃᶰ ᵞᵃ ᴷᵃᵏ ᴺᵍᵉᵗᵃᵍ ᴹᵘˡᵘ ᴾᴹ ᴹᵉᶳʳᵃ ᶳᶤᶰᶤ ","ᴹᵃᵃᶠ ᵏᵃᵏ ᵃᵏᵘ ˡᵃᵍᶤ ᶰᶤᵏᵘᶰᵍ ʲᵃᶰᵍᵃᶰ  ᵍᵃᶰᵍᵍᵘ, " + cName + "?","ᴬᵘ ᵃʰ ᵗᵃᵍ ᵐᵘˡᵘ ᴾᴹ ᴬʲᵃ ᶳᶤʰ, ", "ᴸᵃᵍᶤ ᴬᶰᵘ ᴷᵃᵏ ᴶᵃᶰᵍᵃᶰ ᵀᵃᵍ ᴰᵘˡᵘ ᵀᵃᶰᵍᵍᵘᶰᵍ ᴵᶳʰ, "]
...
#---------------------------------------------------------
		...
		#    cl.sendText(msg.to,"Khusus Admin")
             ...
             cl.sendText(msg.to,van) 
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid':"ue1e44f13de7e46d116bd67ee6696b038"}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"")
